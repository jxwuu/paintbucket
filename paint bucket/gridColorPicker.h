...
class gridColorPicker : public colorPicker
{
  public:
    ...
    /**
    * Picks the color for pixel (x, y). If the x and y coordinate combine to form
    * a line which intercepts the y-axis at a multiple of gridSpacing , it will be filled with the fillColor.
